...
def startCommand(update: Update, context: CallbackContext):
    ...
    buttonC = telegram.InlineKeyboardButton('calculator complex', callback_data='buttonC')
    markup = telegram.InlineKeyboardMarkup(inline_keyboard=[[buttonA], [buttonB], [buttonC]])
